...
function spawnParticle() {
  ...
  el.style.cssText = 'position:fixed;border-radius:50%;pointer-events:none;animation:floatUp 10s ease-in forwards;width:'+size+'px;height:'+size+'px;left:'+(Math.random()*100)+'vw;bottom:0;background:rgba('+hue+',.8);animation-duration:'+(Math.random()*8+6)+'s;animation-delay:'+(Math.random()*4)+'s;';
